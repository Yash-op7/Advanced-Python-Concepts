...
# file = open("test.txt", 'w')    #! there are many options, but the important ones are 'w' - write, 'r' - read, 'a' = append, 'wr' = read and write and so on
...
# file.write("hello\ni wanna die :)")
# file.close() # to make sure there aren't any memory leaks

#! you should just use the 'with' syntax instead of manually opening and closing

# with open("test.txt", 'w') as file:     # use a context manager
#     file.write("ayanogod")
